...
function handleSignoutClick() {
    ...
    if (token !== null) {
        ...
        renderAssignments(assignments); // Update UI
    }
}
    ...
    if (assignmentsToRender.length === 0) {
        container.innerHTML = `
          <div class="empty-state">
            ...
            <p>Adjust your filters/search or click "Authorise Access" to fetch your canvas assignments</p>
          </div>
        `;
        return;
    }
