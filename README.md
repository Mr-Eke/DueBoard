...
**DueBoard** DueBoard helps students stay on top of their assignment deadlines by syncing Canvas assignment events with Google Calendar. The web application presents retrieved data in an easy-to-understand format, allowing users to sort, filter, and search assignments seamlessly. With such an intuitive user interface, **DueBoard** enhances the overall user experience, ensuring students can efficiently manage their academic schedules. 
## Features
